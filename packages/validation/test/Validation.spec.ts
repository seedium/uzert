...
import SchemasGenerator from '../providers/schema-generator.provider';
...
describe('Validation', () => {
  ...
  describe('Custom keyword', () => {
    ...
    it('should transform array of ObjectId to string', () => {
      ...
      const data = {
        array: [new ObjectId(), new ObjectId(), new ObjectId()],
      };
    ...
    it('should transform array of string to ObjectId', async () => {
      ...
      const data = {
        array: [new ObjectId().toHexString(), new ObjectId().toHexString(), new ObjectId().toHexString()],
      };
  ...
  describe('Generate Schema', () => {
    ...
    it('expand test', async () => {
      ...
      expect(JSON.stringify(result)).to.equal(
        JSON.stringify([{ $ref: 'test' }, { $ref: 'test1' }, { $ref: 'test2' }, { $ref: 'test3' }, { $ref: 'test4' }]),
      );
    });
